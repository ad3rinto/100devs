...
let bulsbasaurRc = 16 - 5;
let caterpieRc = 7 - 1;
let weedleRc = 7 - 1;

let totalCandies = bulsbasaurRc + caterpieRc + weedleRc;
console.log(totalCandies)

//Conditionals And Functions
//You have a charmander in your party. Charmander can only battle if the temperature is above 0 degrees celcius.
// Create one function that converts a Fahrenheit value to Celcius and another fuction that tells you wheither or not
...
//Loops
//You have joined an underground pokemon league. In this league, trainers can use any number of pokemon.
...
function printLoop(num) {
    while (num > 0) {
        console.log("Pikachi I choose you", num)
        num--
    }
}